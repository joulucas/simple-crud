api criada com java 11 o profile tes o banco funciona com o h2, no profile dev a base funciona com postgres 12, ao final do arquivo existe o script para inserção 

A ideia é que no segundo commit seja tudo migrado para o lombok. 
